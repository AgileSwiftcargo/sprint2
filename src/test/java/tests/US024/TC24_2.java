...
public class TC24_2 extends CrossTestBaseRapor {
    ...
    @Test
    public void invoiceListesineErisimTesti() {

        extentTest = extentReports.createTest("Invoice  Listesine  Erişim Testi",
        ...
        extentTest.pass("Fatura listesinde AS-4904 İsimli Faturanın Görüntülendiğini Doğrular");
