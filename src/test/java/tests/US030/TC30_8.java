...
public class TC30_8 extends CrossTestBaseRapor {
    ...
    public void PickupPointSilmeTestiPozitif() {
        ...
        extentTest = extentReports.createTest("Pickup Point Silme  Testi Negatif ",
